...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastSpeedControlInteractionEventLocation;

@interface SPTUBIMobilePodcastSpeedControlInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastSpeedControlInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastSpeedControlInteractionEventLocation *location; // @synthesize location=_location;
