...
#import "SPTCarmageddonRemoteConfiguration-Protocol.h"

@class NSString, SPTCarmageddonFeatureProperties;

@interface SPTCarmageddonRemoteConfigurationImplementation : NSObject <SPTCarmageddonRemoteConfiguration>
{
    SPTCarmageddonFeatureProperties *_remoteProperties;
}
