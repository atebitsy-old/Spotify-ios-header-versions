...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastUnfinishedEpisodeCardInteractionEventLocation;

@interface SPTUBIMobilePodcastUnfinishedEpisodeCardInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastUnfinishedEpisodeCardInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastUnfinishedEpisodeCardInteractionEventLocation *location; // @synthesize location=_location;
