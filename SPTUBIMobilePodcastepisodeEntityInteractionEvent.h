...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastepisodeEntityInteractionEventLocation;

@interface SPTUBIMobilePodcastepisodeEntityInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastepisodeEntityInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastepisodeEntityInteractionEventLocation *location; // @synthesize location=_location;
