...
@class NSArray, NSDictionary, NSString, SPTUBIMobileSleepTimerInteractionEventLocation;

@interface SPTUBIMobileSleepTimerInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileSleepTimerInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileSleepTimerInteractionEventLocation *location; // @synthesize location=_location;
