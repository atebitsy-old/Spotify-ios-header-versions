...
@class NSArray, NSDictionary, NSString, SPTUBIMobileExternalAccessoryInteractionEventLocation;

@interface SPTUBIMobileExternalAccessoryInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileExternalAccessoryInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileExternalAccessoryInteractionEventLocation *location; // @synthesize location=_location;
