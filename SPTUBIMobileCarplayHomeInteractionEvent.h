...
@class NSArray, NSDictionary, NSString, SPTUBIMobileCarplayHomeInteractionEventLocation;

@interface SPTUBIMobileCarplayHomeInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileCarplayHomeInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileCarplayHomeInteractionEventLocation *location; // @synthesize location=_location;
