...
@class NSArray, NSDictionary, NSString, SPTUBIFTEMobileTrackPageFreeInteractionEventLocation;

@interface SPTUBIFTEMobileTrackPageFreeInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIFTEMobileTrackPageFreeInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIFTEMobileTrackPageFreeInteractionEventLocation *location; // @synthesize location=_location;
