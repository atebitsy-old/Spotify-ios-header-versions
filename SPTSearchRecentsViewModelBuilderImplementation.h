...
- (id)initWithRecentsCommandName:(id)arg1 playTracksEnabled:(_Bool)arg2 shouldRoundPodcastArtwork:(_Bool)arg3 explicitContentPlaybackAllowed:(_Bool)arg4 ageRestrictedContentPlaybackAllowed:(_Bool)arg5 ubiHubsInstrumentation:(id)arg6 featureID:(id)arg7 pageURI:(id)arg8 referrerIdentifier:(id)arg9;
