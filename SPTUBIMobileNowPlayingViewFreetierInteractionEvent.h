...
@class NSArray, NSDictionary, NSString, SPTUBIMobileNowPlayingViewFreetierInteractionEventLocation;

@interface SPTUBIMobileNowPlayingViewFreetierInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileNowPlayingViewFreetierInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileNowPlayingViewFreetierInteractionEventLocation *location; // @synthesize location=_location;
