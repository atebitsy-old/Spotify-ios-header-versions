...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastEntitySortInteractionEventLocation;

@interface SPTUBIMobilePodcastEntitySortInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastEntitySortInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastEntitySortInteractionEventLocation *location; // @synthesize location=_location;
