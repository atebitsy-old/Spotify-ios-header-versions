...
@class NSArray, NSDictionary, NSString, SPTUBIMobileExplicitcontentInteractionEventLocation;

@interface SPTUBIMobileExplicitcontentInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileExplicitcontentInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileExplicitcontentInteractionEventLocation *location; // @synthesize location=_location;
