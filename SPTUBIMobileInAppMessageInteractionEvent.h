...
@class NSArray, NSDictionary, NSString, SPTUBIMobileInAppMessageInteractionEventLocation;

@interface SPTUBIMobileInAppMessageInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileInAppMessageInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileInAppMessageInteractionEventLocation *location; // @synthesize location=_location;
