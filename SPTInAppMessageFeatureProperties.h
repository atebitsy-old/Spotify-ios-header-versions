...
@interface SPTInAppMessageFeatureProperties : NSObject <SPTRemoteConfigurationProperties>
{
    ...
    _Bool _inappEmailVerificationActionEnabled;
}

@property(readonly, nonatomic) _Bool inappEmailVerificationActionEnabled; // @synthesize inappEmailVerificationActionEnabled=_inappEmailVerificationActionEnabled;
