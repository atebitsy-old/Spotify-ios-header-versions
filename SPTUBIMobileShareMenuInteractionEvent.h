...
@class NSArray, NSDictionary, NSString, SPTUBIMobileShareMenuInteractionEventLocation;

@interface SPTUBIMobileShareMenuInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileShareMenuInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileShareMenuInteractionEventLocation *location; // @synthesize location=_location;
