...
@protocol SPTHugsFactory, SPTPerformanceMetricsViewLoggerFactory;
...
- (id)createRemoteContentOperationlLoaderForContentURL:(id)arg1 sourceIdentifier:(id)arg2 overrides:(id)arg3;
- (id)createCachedContentOperationLoaderWithOverrides:(id)arg1;
- (id)initWithContentOperationFactory:(id)arg1 hugsFactory:(id)arg2 viewLoggerFactory:(id)arg3;
