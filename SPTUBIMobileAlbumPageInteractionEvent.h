...
@class NSArray, NSDictionary, NSString, SPTUBIMobileAlbumPageInteractionEventLocation;

@interface SPTUBIMobileAlbumPageInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileAlbumPageInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileAlbumPageInteractionEventLocation *location; // @synthesize location=_location;
