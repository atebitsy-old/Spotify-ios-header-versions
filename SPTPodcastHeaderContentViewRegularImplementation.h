...
@interface SPTPodcastHeaderContentViewRegularImplementation : VISREFTopAndBodyContentView <SPTPodcastHeaderContentView>
{
    ...
    CDStruct_5a28e70a _imageScaleProgressRange;
...
@property(nonatomic) CDStruct_5a28e70a imageScaleProgressRange; // @synthesize imageScaleProgressRange=_imageScaleProgressRange;
