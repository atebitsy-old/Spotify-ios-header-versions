...
#import "SPTUBIMobileNowPlayingViewFreetierEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileNowPlayingViewFreetierEventFactoryImplementation : NSObject <SPTUBIMobileNowPlayingViewFreetierEventFactory>
{
    NSArray *_components;
}
