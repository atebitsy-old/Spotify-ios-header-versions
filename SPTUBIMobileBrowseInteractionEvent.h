...
@class NSArray, NSDictionary, NSString, SPTUBIMobileBrowseInteractionEventLocation;

@interface SPTUBIMobileBrowseInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileBrowseInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileBrowseInteractionEventLocation *location; // @synthesize location=_location;
