...
@class BMContentDownloader, SPTPlayerItemNotificationObservable, SPTVideoApplicationStateObservable;
...
- (id)initWithDataLoader:(id)arg1 connectionModeObservable:(id)arg2 kvoControllerFactory:(id)arg3 contentDownloader:(id)arg4 logger:(id)arg5 notificationCenter:(id)arg6 appStateObservable:(id)arg7 playerItemObservable:(id)arg8 playbackErrorFormatter:(id)arg9;
- (id)initWithDataLoader:(id)arg1 connectionModeObservable:(id)arg2 kvoControllerFactory:(id)arg3 contentDownloader:(id)arg4 logger:(id)arg5;
