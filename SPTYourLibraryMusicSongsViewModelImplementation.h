...
- (_Bool)isPlaying;
- (void)sortingFilteringButtonsContainer:(id)arg1 deselectedFilterRule:(id)arg2;
- (void)sortingFilteringButtonsContainer:(id)arg1 selectedFilterRule:(id)arg2;
...
- (_Bool)isFilterButtonsCellAtIndex:(id)arg1;
- (_Bool)isAdditionalControlsSection:(unsigned long long)arg1;
- (_Bool)showFilterButtons;
