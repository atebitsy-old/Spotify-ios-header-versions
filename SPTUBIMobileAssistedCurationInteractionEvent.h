...
@class NSArray, NSDictionary, NSString, SPTUBIMobileAssistedCurationInteractionEventLocation;

@interface SPTUBIMobileAssistedCurationInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileAssistedCurationInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileAssistedCurationInteractionEventLocation *location; // @synthesize location=_location;
