...
@interface SPTCanvasLegacyLogger : NSObject <SPForegroundObserverDelegate, SPTFeatureFlagSignalObserver, SPTPlayerObserver, SPTGaiaConnectObserver, SPTCanvasLoadStateTrackerObserver, SPTCanvasNowPlayingViewStateObserver>
{
