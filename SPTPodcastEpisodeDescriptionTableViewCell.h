...
@class GLUELabel, NSLayoutConstraint, NSString, NSURL, SPTPodcastEpisodeDescriptionTextView, SPTPodcastEpisodeFeatureProperties, UIStackView;
...
- (id)initWithHtmlParser:(id)arg1 featureProperties:(id)arg2;
