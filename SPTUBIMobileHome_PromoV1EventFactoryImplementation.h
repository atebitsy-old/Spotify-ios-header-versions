...
#import "SPTUBIMobileHome_PromoV1EventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileHome_PromoV1EventFactoryImplementation : NSObject <SPTUBIMobileHome_PromoV1EventFactory>
{
    NSArray *_components;
}
