...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePlaylistExtenderInteractionEventLocation;

@interface SPTUBIMobilePlaylistExtenderInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePlaylistExtenderInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePlaylistExtenderInteractionEventLocation *location; // @synthesize location=_location;
