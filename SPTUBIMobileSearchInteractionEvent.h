...
@class NSArray, NSDictionary, NSString, SPTUBIMobileSearchInteractionEventLocation;

@interface SPTUBIMobileSearchInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileSearchInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileSearchInteractionEventLocation *location; // @synthesize location=_location;
