...
@class NSArray, NSDictionary, NSString, SPTUBIMobileConnectVolumeControlInteractionEventLocation;

@interface SPTUBIMobileConnectVolumeControlInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileConnectVolumeControlInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileConnectVolumeControlInteractionEventLocation *location; // @synthesize location=_location;
