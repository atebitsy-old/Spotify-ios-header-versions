...
+ (id)customDataForEntity:(id)arg1 onDemandAllowed:(_Bool)arg2 explicitContentEnabled:(_Bool)arg3 ageRestrictedContentEnabled:(_Bool)arg4 newPodcastRowsEnabled:(_Bool)arg5;
...
+ (id)commandsForEntity:(id)arg1 query:(id)arg2 referrerIdentifier:(id)arg3 newPodcastRowsEnabled:(_Bool)arg4 explicitContentEnabled:(_Bool)arg5 ageRestrictedContentEnabled:(_Bool)arg6 onDemandAllowed:(_Bool)arg7;
+ (id)accessoryTitleForEntity:(id)arg1 newPodcastRowsEnabled:(_Bool)arg2;
+ (id)defaultRowComponentIdentifier;
+ (id)componentIdentifierForEntity:(id)arg1 newPodcastRowsEnabled:(_Bool)arg2;
+ (id)rowForEntity:(id)arg1 componentModelIdentifier:(id)arg2 drilldown:(_Bool)arg3 onDemandAllowed:(_Bool)arg4 explicitContentEnabled:(_Bool)arg5 ageRestrictedContentEnabled:(_Bool)arg6 query:(id)arg7 referrerIdentifier:(id)arg8 newPodcastRowsEnabled:(_Bool)arg9 sectionID:(id)arg10 requestID:(id)arg11 pageURI:(id)arg12 position:(long long)arg13 ubiLocationSerializer:(id)arg14;
