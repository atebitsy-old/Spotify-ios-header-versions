...
@class NSArray, NSDictionary, NSString, SPTUBIMobileCarplayPlayableContentInteractionEventLocation;

@interface SPTUBIMobileCarplayPlayableContentInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileCarplayPlayableContentInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileCarplayPlayableContentInteractionEventLocation *location; // @synthesize location=_location;
