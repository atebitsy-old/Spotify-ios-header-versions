...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePlaylistEntityInteractionEventLocation;

@interface SPTUBIMobilePlaylistEntityInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePlaylistEntityInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePlaylistEntityInteractionEventLocation *location; // @synthesize location=_location;
