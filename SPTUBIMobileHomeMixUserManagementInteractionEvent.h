...
@class NSArray, NSDictionary, NSString, SPTUBIMobileHomeMixUserManagementInteractionEventLocation;

@interface SPTUBIMobileHomeMixUserManagementInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileHomeMixUserManagementInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileHomeMixUserManagementInteractionEventLocation *location; // @synthesize location=_location;
