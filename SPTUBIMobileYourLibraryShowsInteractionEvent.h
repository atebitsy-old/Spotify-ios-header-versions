...
@class NSArray, NSDictionary, NSString, SPTUBIMobileYourLibraryShowsInteractionEventLocation;

@interface SPTUBIMobileYourLibraryShowsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileYourLibraryShowsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileYourLibraryShowsInteractionEventLocation *location; // @synthesize location=_location;
