...
@class NSArray, NSDictionary, NSString, SPTUBIMobileConcertsHubInteractionEventLocation;

@interface SPTUBIMobileConcertsHubInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileConcertsHubInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileConcertsHubInteractionEventLocation *location; // @synthesize location=_location;
