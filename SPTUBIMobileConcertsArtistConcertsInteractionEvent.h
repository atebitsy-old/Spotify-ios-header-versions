...
@class NSArray, NSDictionary, NSString, SPTUBIMobileConcertsArtistConcertsInteractionEventLocation;

@interface SPTUBIMobileConcertsArtistConcertsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileConcertsArtistConcertsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileConcertsArtistConcertsInteractionEventLocation *location; // @synthesize location=_location;
