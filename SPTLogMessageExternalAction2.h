...
@interface SPTLogMessageExternalAction2 : SPTLogMessage
{
...
+ (id)messageWithSessionId:(id)arg1 actionType:(id)arg2 userIntent:(id)arg3 uri:(id)arg4 playbackId:(id)arg5;
