...
@class GLUEImageView, NSString, NSURL, SPTGaiaDevicePickerGLUETheme, UIColor;
@protocol GLUEImageLoader, SPTGaiaDevicePickerClonedCellDelegate;

@interface SPTGaiaDevicePickerClonedCell : GLUEEntityRowTableViewCell
{
    _Bool _animating;
    _Bool _loggedIn;
    ...
    NSURL *_imageViewUrl;
    id <SPTGaiaDevicePickerClonedCellDelegate> _delegate;
    NSString *_subtitle;
...
@property(nonatomic) __weak id <SPTGaiaDevicePickerClonedCellDelegate> delegate; // @synthesize delegate=_delegate;
