...
#import "SPTFreeTierPlaylistLogger-Protocol.h"
...
@interface SPTFreeTierPlaylistLoggerImplementation : NSObject <SPTFreeTierPlaylistLogger, SPTFreeTierPlaylistModelObserver>
{
...
@property(retain, nonatomic) NSString *playlistViewPageIdentifier; // @synthesize playlistViewPageIdentifier=_playlistViewPageIdentifier;
