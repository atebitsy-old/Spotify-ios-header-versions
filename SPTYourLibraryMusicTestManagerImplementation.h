...
- (id)initWithFeatureFlagFactory:(id)arg1 productState:(id)arg2 remoteConfigurationResolver:(id)arg3 collectionPlatformTestManager:(id)arg4 yourLibrarySignal:(id)arg5 consolidatedExperienceSignal:(id)arg6 encoreTestManager:(id)arg7;
