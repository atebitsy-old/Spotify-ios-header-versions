...
@class NSArray, NSDictionary, NSString, SPTUBIMobileStorylinesInteractionEventLocation;

@interface SPTUBIMobileStorylinesInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileStorylinesInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileStorylinesInteractionEventLocation *location; // @synthesize location=_location;
