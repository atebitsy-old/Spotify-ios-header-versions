...
{
    id <SPTInAppMessageQAToolBannerViewDelegate> _delegate;
...
@property(nonatomic) __weak id <SPTInAppMessageQAToolBannerViewDelegate> delegate; // @synthesize delegate=_delegate;
