...
@class NSArray, NSString, SPTUBIMobileAssistedCurationEventLocation;

@interface SPTUBIMobileAssistedCurationImpressionEvent : NSObject <SPTUBIImpressionEvent>
{
    SPTUBIMobileAssistedCurationEventLocation *_location;
    NSArray *_errors;
}

- (void).cxx_destruct;
@property(copy, nonatomic) NSArray *errors; // @synthesize errors=_errors;
@property(retain, nonatomic) SPTUBIMobileAssistedCurationEventLocation *location; // @synthesize location=_location;
