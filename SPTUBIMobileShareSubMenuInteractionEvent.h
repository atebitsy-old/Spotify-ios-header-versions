...
@class NSArray, NSDictionary, NSString, SPTUBIMobileShareSubMenuInteractionEventLocation;

@interface SPTUBIMobileShareSubMenuInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileShareSubMenuInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileShareSubMenuInteractionEventLocation *location; // @synthesize location=_location;
