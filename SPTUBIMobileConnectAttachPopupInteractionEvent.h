...
@class NSArray, NSDictionary, NSString, SPTUBIMobileConnectAttachPopupInteractionEventLocation;

@interface SPTUBIMobileConnectAttachPopupInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileConnectAttachPopupInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileConnectAttachPopupInteractionEventLocation *location; // @synthesize location=_location;
