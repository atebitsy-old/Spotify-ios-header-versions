...
@class NSArray, NSDictionary, NSString, SPTUBIMobileSocialListeningParticipantsInteractionEventLocation;

@interface SPTUBIMobileSocialListeningParticipantsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileSocialListeningParticipantsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileSocialListeningParticipantsInteractionEventLocation *location; // @synthesize location=_location;
