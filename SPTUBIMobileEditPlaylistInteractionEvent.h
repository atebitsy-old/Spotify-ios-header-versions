...
@class NSArray, NSDictionary, NSString, SPTUBIMobileEditPlaylistInteractionEventLocation;

@interface SPTUBIMobileEditPlaylistInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileEditPlaylistInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileEditPlaylistInteractionEventLocation *location; // @synthesize location=_location;
