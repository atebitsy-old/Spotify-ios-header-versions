...
@class NSArray, NSDictionary, NSString, SPTUBIMobileCollectionArtistInteractionEventLocation;

@interface SPTUBIMobileCollectionArtistInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileCollectionArtistInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileCollectionArtistInteractionEventLocation *location; // @synthesize location=_location;
