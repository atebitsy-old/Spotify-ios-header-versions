...
#import "SPTUBIMobileHome_Shelves_Shelf_CarouselEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileHome_Shelves_Shelf_CarouselEventFactoryImplementation : NSObject <SPTUBIMobileHome_Shelves_Shelf_CarouselEventFactory>
{
    NSArray *_components;
}
