...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastEntityInteractionEventLocation;

@interface SPTUBIMobilePodcastEntityInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastEntityInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastEntityInteractionEventLocation *location; // @synthesize location=_location;
