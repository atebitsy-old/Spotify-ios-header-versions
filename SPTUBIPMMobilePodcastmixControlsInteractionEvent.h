...
@class NSArray, NSDictionary, NSString, SPTUBIPMMobilePodcastmixControlsInteractionEventLocation;

@interface SPTUBIPMMobilePodcastmixControlsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIPMMobilePodcastmixControlsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIPMMobilePodcastmixControlsInteractionEventLocation *location; // @synthesize location=_location;
