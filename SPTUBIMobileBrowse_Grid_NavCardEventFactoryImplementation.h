...
#import "SPTUBIMobileBrowse_Grid_NavCardEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileBrowse_Grid_NavCardEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_Grid_NavCardEventFactory>
{
    NSArray *_components;
}
