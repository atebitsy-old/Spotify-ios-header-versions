...
#import "SPTControllableTabBarControllerProtocol-Protocol.h"
...
@interface SPTAdaptiveTabBarController : UITabBarController <UITabBarControllerDelegate, SPContentInsetViewController, SPTControllableTabBarControllerProtocol, SPTInitialViewController>
{
...
- (void)updateTabBarVisibilityForTraitCollection;
...
- (void)applyCustomSelectionActionsAfterProgrammaticallySelectingController:(id)arg1;
- (void)reactToControllerSelection:(id)arg1;
