...
@class NSArray, NSDictionary, NSString, SPTUBIMobileArtistAboutInteractionEventLocation;

@interface SPTUBIMobileArtistAboutInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileArtistAboutInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileArtistAboutInteractionEventLocation *location; // @synthesize location=_location;
