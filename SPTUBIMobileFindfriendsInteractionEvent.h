...
@class NSArray, NSDictionary, NSString, SPTUBIMobileFindfriendsInteractionEventLocation;

@interface SPTUBIMobileFindfriendsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileFindfriendsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileFindfriendsInteractionEventLocation *location; // @synthesize location=_location;
