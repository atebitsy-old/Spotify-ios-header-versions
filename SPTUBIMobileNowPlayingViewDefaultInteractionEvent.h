...
@class NSArray, NSDictionary, NSString, SPTUBIMobileNowPlayingViewDefaultInteractionEventLocation;

@interface SPTUBIMobileNowPlayingViewDefaultInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileNowPlayingViewDefaultInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileNowPlayingViewDefaultInteractionEventLocation *location; // @synthesize location=_location;
