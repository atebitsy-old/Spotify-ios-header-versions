...
@class NSString;
@protocol HUBComponentModel, SPTHomeUIHabitsCardViewModelDelegate, SPTPlayer;

@interface SPTHomeUIHabitsCardViewModel : NSObject <SPTPlayerObserver>
{
    _Bool _isActiveContext;
    id <SPTHomeUIHabitsCardViewModelDelegate> _delegate;
...
@property(nonatomic) __weak id <SPTHomeUIHabitsCardViewModelDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
