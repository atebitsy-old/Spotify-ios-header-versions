...
@class NSArray, NSDictionary, NSString, SPTUBIMobileNowPlayingViewPodcastInteractionEventLocation;

@interface SPTUBIMobileNowPlayingViewPodcastInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileNowPlayingViewPodcastInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileNowPlayingViewPodcastInteractionEventLocation *location; // @synthesize location=_location;
