...
@class NSArray, NSDictionary, NSString, SPTUBIMobileCarplayTabsInteractionEventLocation;

@interface SPTUBIMobileCarplayTabsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileCarplayTabsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileCarplayTabsInteractionEventLocation *location; // @synthesize location=_location;
