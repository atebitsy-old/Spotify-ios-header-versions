...
@class NSArray, NSDictionary, NSString, SPTUBIMobileHomeMixTasteVizInteractionEventLocation;

@interface SPTUBIMobileHomeMixTasteVizInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileHomeMixTasteVizInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileHomeMixTasteVizInteractionEventLocation *location; // @synthesize location=_location;
