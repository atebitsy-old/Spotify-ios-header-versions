...
- (void)fetchPlaylistTracksForPlaylistURL:(NSURL *)arg1 options:(SPTPlaylistPlatformPlaylistTracksFetchOptions *)arg2 withPolicyProtocols:(NSArray *)arg3 replyOnMainThread:(_Bool)arg4 completion:(void (^)(struct SPTPlaylistPlatformDataLoaderResponse *))arg5 onError:(void (^)(NSError *))arg6;
