...
@class NSArray, NSURL, SPTLoggingParams, SPTPlayOptions, SPTPlaylistPlatformFolderItemFetchOptions, SPTPlaylistPlatformFolderItemSubscriptionOptions, SPTPlaylistPlatformPlayOptions, SPTPlaylistPlatformPlaylistMetadataFetchOptions, SPTPlaylistPlatformPlaylistMetadataSubscriptionOptions, SPTPlaylistPlatformPlaylistTracksFetchOptions, SPTPlaylistPlatformPlaylistTracksSubscriptionOptions;
...
- (void)playWithURL:(NSURL *)arg1 playOptions:(SPTPlayOptions *)arg2 playlistOptions:(SPTPlaylistPlatformPlayOptions *)arg3 loggingParams:(SPTLoggingParams *)arg4 completion:(void (^)(void))arg5 onError:(void (^)(NSError *))arg6;
...
- (id <SPTPlaylistPlatformDataLoaderRequestToken>)subscribePlaylistTracksForPlaylistURL:(NSURL *)arg1 options:(SPTPlaylistPlatformPlaylistTracksSubscriptionOptions *)arg2 withPolicyProtocols:(NSArray *)arg3 completion:(void (^)(id))arg4 onError:(void (^)(NSError *))arg5;
...
- (void)fetchPlaylistViewForPlaylistURL:(NSURL *)arg1 options:(SPTPlaylistPlatformPlaylistTracksFetchOptions *)arg2 withMetadataProtocols:(NSArray *)arg3 andTrackProtocols:(NSArray *)arg4 completion:(void (^)(id <SPTPlaylistPlatformDataLoaderField>, id))arg5 onError:(void (^)(NSError *))arg6;
- (void)fetchFolderItemsForFolderURL:(NSURL *)arg1 options:(SPTPlaylistPlatformFolderItemFetchOptions *)arg2 withFolderPolicyProtocols:(NSArray *)arg3 withPlaylistPolicyProtocols:(NSArray *)arg4 replyOnMainThread:(_Bool)arg5 completion:(void (^)(SPTPlaylistPlatformFolderResponse *))arg6 onError:(void (^)(NSError *))arg7;
...
- (void)fetchPlaylistTracksForPlaylistURL:(NSURL *)arg1 options:(SPTPlaylistPlatformPlaylistTracksFetchOptions *)arg2 withPolicyProtocols:(NSArray *)arg3 replyOnMainThread:(_Bool)arg4 completion:(void (^)(id))arg5 onError:(void (^)(NSError *))arg6;
- (void)fetchPlaylistMetadataForPlaylistURL:(NSURL *)arg1 options:(SPTPlaylistPlatformPlaylistMetadataFetchOptions *)arg2 withPolicyProtocols:(NSArray *)arg3 replyOnMainThread:(_Bool)arg4 completion:(void (^)(id <SPTPlaylistPlatformDataLoaderField>))arg5 onError:(void (^)(NSError *))arg6;
@end
