...
@class SPTHomeUIHabitsLargeCardView, UISelectionFeedbackGenerator, UITapGestureRecognizer;
@protocol HUBComponentEventHandler;

@interface SPTHomeUIHabitsLargeCardComponentView : HUGSThemableComponentView <HUBComponentViewWithImageHandling, HUBComponentViewWithEvents>
{
    id <HUBComponentEventHandler> _eventHandler;
    SPTHomeUIHabitsLargeCardView *_cardView;
...
@property(readonly, nonatomic) SPTHomeUIHabitsLargeCardView *cardView; // @synthesize cardView=_cardView;
