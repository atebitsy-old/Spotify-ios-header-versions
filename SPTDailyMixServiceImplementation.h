...
@protocol SPTCollectionPlatformService, SPTContainerService, SPTDailyMixFeedbackUIModel, SPTGLUEService, SPTHubFrameworkService, SPTLocalSettings, SPTNetworkService, SPTNowPlayingRemoteControlPolicy, SPTPlayerFeature, SPTRadioService, SPTSessionService;
