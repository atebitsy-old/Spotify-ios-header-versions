...
@class NSArray, NSDictionary, NSString, SPTUBIGAIAMobileConnectDevicesAvailableInteractionEventLocation;

@interface SPTUBIGAIAMobileConnectDevicesAvailableInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIGAIAMobileConnectDevicesAvailableInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIGAIAMobileConnectDevicesAvailableInteractionEventLocation *location; // @synthesize location=_location;
