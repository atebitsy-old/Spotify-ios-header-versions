...
@class NSArray, NSDictionary, NSString, SPTUBIMobileArtistPageInteractionEventLocation;

@interface SPTUBIMobileArtistPageInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileArtistPageInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileArtistPageInteractionEventLocation *location; // @synthesize location=_location;
