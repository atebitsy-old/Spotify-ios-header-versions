...
#import "SPTUBIMobileHome_PromoV2EventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileHome_PromoV2EventFactoryImplementation : NSObject <SPTUBIMobileHome_PromoV2EventFactory>
{
    NSArray *_components;
}
