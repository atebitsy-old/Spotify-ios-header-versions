...
#import "SPTUserBehaviourHubsInstrumentation-Protocol.h"

@class NSString, NSURL;

@interface SPTUserBehaviourHubsInstrumentationImplementation : NSObject <SPTUserBehaviourHubsInstrumentation>
{
    NSURL *_pageURI;
    NSString *_pageId;
}
