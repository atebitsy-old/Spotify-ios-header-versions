...
@class NSArray, NSDictionary, NSString, SPTUBIMobileYourLibraryInteractionEventLocation;

@interface SPTUBIMobileYourLibraryInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileYourLibraryInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileYourLibraryInteractionEventLocation *location; // @synthesize location=_location;
