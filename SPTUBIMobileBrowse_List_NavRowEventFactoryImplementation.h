...
#import "SPTUBIMobileBrowse_List_NavRowEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileBrowse_List_NavRowEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_List_NavRowEventFactory>
{
    NSArray *_components;
}
