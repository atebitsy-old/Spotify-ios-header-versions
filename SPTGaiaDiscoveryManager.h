...
@class NSNotificationCenter, NSString, SPTCastManager, SPTGaiaConnectCosmosResolver, SPTGaiaLocalNetworkPermissionManager;
...
- (void)devicePickerDidAppear;
- (void)localNetworkAccessChanged:(_Bool)arg1;
- (void)startDeviceDiscovery;
- (_Bool)shouldManuallyStartConnectDiscovery;
- (void)startDeviceDiscoveryIfAllowed;
- (void)dealloc;
- (void)startObserving;
- (id)initWithPermissionManager:(id)arg1 cosmosResolver:(id)arg2 castManager:(id)arg3 notificationCenter:(id)arg4;
