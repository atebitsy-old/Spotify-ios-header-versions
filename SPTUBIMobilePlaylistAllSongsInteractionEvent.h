...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePlaylistAllSongsInteractionEventLocation;

@interface SPTUBIMobilePlaylistAllSongsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePlaylistAllSongsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePlaylistAllSongsInteractionEventLocation *location; // @synthesize location=_location;
