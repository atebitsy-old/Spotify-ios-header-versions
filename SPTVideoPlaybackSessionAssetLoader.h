...
@class AVContentKeySession, BMAVFactory, BMBetamaxOfflineManager, NSString;
...
- (id)initWithAVFactory:(id)arg1 offlineManager:(id)arg2 resourceLoader:(id)arg3 contentKeySession:(id)arg4;
