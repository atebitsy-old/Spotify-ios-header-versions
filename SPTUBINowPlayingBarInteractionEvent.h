...
@class NSArray, NSDictionary, NSString, SPTUBINowPlayingBarInteractionEventLocation;

@interface SPTUBINowPlayingBarInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBINowPlayingBarInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBINowPlayingBarInteractionEventLocation *location; // @synthesize location=_location;
