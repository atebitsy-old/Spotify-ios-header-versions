...
@class NSString, SPTLoginLinkAccountDataLoader, SPTLoginSlideUpModalPresenter, SPTLoginTheme;
...
- (void).cxx_destruct;
- (void)dataLoaderDidFailLinkAccount:(id)arg1;
...
- (id)initWithDataLoader:(id)arg1 modalPresenter:(id)arg2 theme:(id)arg3;
