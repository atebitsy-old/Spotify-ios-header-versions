...
@class NSArray, NSDictionary, NSString, SPTUBIMobileScannablesInteractionEventLocation;

@interface SPTUBIMobileScannablesInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileScannablesInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileScannablesInteractionEventLocation *location; // @synthesize location=_location;
