...
#import "SPTUBIMobileCollectionArtist_ItemList_ItemEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileCollectionArtist_ItemList_ItemEventFactoryImplementation : NSObject <SPTUBIMobileCollectionArtist_ItemList_ItemEventFactory>
{
    NSArray *_components;
}
