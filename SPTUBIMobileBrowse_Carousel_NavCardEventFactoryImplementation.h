...
#import "SPTUBIMobileBrowse_Carousel_NavCardEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileBrowse_Carousel_NavCardEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_Carousel_NavCardEventFactory>
{
    NSArray *_components;
}
