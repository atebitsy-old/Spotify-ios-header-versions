...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastFeaturedTracklistInteractionEventLocation;

@interface SPTUBIMobilePodcastFeaturedTracklistInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastFeaturedTracklistInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastFeaturedTracklistInteractionEventLocation *location; // @synthesize location=_location;
