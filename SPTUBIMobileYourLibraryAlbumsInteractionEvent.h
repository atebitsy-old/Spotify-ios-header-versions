...
@class NSArray, NSDictionary, NSString, SPTUBIMobileYourLibraryAlbumsInteractionEventLocation;

@interface SPTUBIMobileYourLibraryAlbumsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileYourLibraryAlbumsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileYourLibraryAlbumsInteractionEventLocation *location; // @synthesize location=_location;
