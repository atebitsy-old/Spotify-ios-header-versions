...
@class NSArray, NSDictionary, NSString, SPTUBIGAIAMobileConnectSettingsPageInteractionEventLocation;

@interface SPTUBIGAIAMobileConnectSettingsPageInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIGAIAMobileConnectSettingsPageInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIGAIAMobileConnectSettingsPageInteractionEventLocation *location; // @synthesize location=_location;
