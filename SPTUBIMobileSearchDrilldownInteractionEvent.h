...
@class NSArray, NSDictionary, NSString, SPTUBIMobileSearchDrilldownInteractionEventLocation;

@interface SPTUBIMobileSearchDrilldownInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileSearchDrilldownInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileSearchDrilldownInteractionEventLocation *location; // @synthesize location=_location;
