...
#import "SPTUBIMobileBrowse_PageHeader_TopicEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileBrowse_PageHeader_TopicEventFactoryImplementation : NSObject <SPTUBIMobileBrowse_PageHeader_TopicEventFactory>
{
    NSArray *_components;
}
