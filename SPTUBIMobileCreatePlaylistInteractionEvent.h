...
@class NSArray, NSDictionary, NSString, SPTUBIMobileCreatePlaylistInteractionEventLocation;

@interface SPTUBIMobileCreatePlaylistInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileCreatePlaylistInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileCreatePlaylistInteractionEventLocation *location; // @synthesize location=_location;
