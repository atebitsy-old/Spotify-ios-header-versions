...
- (id)createCommandHandlerForViewURI:(id)arg1 referrerIdentifier:(id)arg2 offlineModel:(id)arg3 reloadPageSignalSource:(id)arg4 explicitContentAccessManager:(id)arg5;
