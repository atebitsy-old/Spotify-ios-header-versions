...
@class NSArray, NSDictionary, NSString, SPTUBIMobileNowPlayingViewFeedbackInteractionEventLocation;

@interface SPTUBIMobileNowPlayingViewFeedbackInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileNowPlayingViewFeedbackInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileNowPlayingViewFeedbackInteractionEventLocation *location; // @synthesize location=_location;
