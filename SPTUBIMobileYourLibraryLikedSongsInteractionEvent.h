...
@class NSArray, NSDictionary, NSString, SPTUBIMobileYourLibraryLikedSongsInteractionEventLocation;

@interface SPTUBIMobileYourLibraryLikedSongsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileYourLibraryLikedSongsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileYourLibraryLikedSongsInteractionEventLocation *location; // @synthesize location=_location;
