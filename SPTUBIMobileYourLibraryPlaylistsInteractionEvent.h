...
@class NSArray, NSDictionary, NSString, SPTUBIMobileYourLibraryPlaylistsInteractionEventLocation;

@interface SPTUBIMobileYourLibraryPlaylistsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileYourLibraryPlaylistsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileYourLibraryPlaylistsInteractionEventLocation *location; // @synthesize location=_location;
