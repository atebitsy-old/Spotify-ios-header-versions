...
@class NSArray, NSDictionary, NSString, SPTUBIMobileHomeMixFacePileDetailInteractionEventLocation;

@interface SPTUBIMobileHomeMixFacePileDetailInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileHomeMixFacePileDetailInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileHomeMixFacePileDetailInteractionEventLocation *location; // @synthesize location=_location;
