...
- (void)enqueueTrackWithURI:(id)arg1 externalActionOrigin:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;
...
- (void)disableRepeatWithExternalActionOrigin:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)repeatTrackWithExternalActionOrigin:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)repeatContextWithExternalActionOrigin:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)disableShuffleWithExternalActionOrigin:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)enableShuffleWithExternalActionOrigin:(id)arg1 completionHandler:(CDUnknownBlockType)arg2;
