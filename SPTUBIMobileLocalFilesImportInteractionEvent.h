...
@class NSArray, NSDictionary, NSString, SPTUBIMobileLocalFilesImportInteractionEventLocation;

@interface SPTUBIMobileLocalFilesImportInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileLocalFilesImportInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileLocalFilesImportInteractionEventLocation *location; // @synthesize location=_location;
