...
- (void)fetchAllTracksWithPolicyProtocols:(id)arg1 options:(id)arg2 replyOnMainThread:(_Bool)arg3 completion:(CDUnknownBlockType)arg4 onError:(CDUnknownBlockType)arg5;
...
- (void)fetchArtistTracksForArtistURL:(id)arg1 withPolicyProtocols:(id)arg2 options:(id)arg3 replyOnMainThread:(_Bool)arg4 completion:(CDUnknownBlockType)arg5 onError:(CDUnknownBlockType)arg6;
...
- (void)fetchArtistViewForArtistURL:(id)arg1 withMetadataProtocols:(id)arg2 andTracksProtocols:(id)arg3 options:(id)arg4 replyOnMainThread:(_Bool)arg5 completion:(CDUnknownBlockType)arg6 onError:(CDUnknownBlockType)arg7;
...
- (void)fetchArtistsMetadataWithPolicyProtocols:(id)arg1 options:(id)arg2 replyOnMainThread:(_Bool)arg3 completion:(CDUnknownBlockType)arg4 onError:(CDUnknownBlockType)arg5;
...
- (void)fetchAlbumTracksForAlbumURL:(id)arg1 withPolicyProtocols:(id)arg2 options:(id)arg3 replyOnMainThread:(_Bool)arg4 completion:(CDUnknownBlockType)arg5 onError:(CDUnknownBlockType)arg6;
...
- (void)fetchAlbumViewForAlbumURL:(id)arg1 withMetadataProtocols:(id)arg2 andTracksProtocols:(id)arg3 options:(id)arg4 replyOnMainThread:(_Bool)arg5 completion:(CDUnknownBlockType)arg6 onError:(CDUnknownBlockType)arg7;
...
- (void)fetchAlbumsMetadataWithPolicyProtocols:(id)arg1 options:(id)arg2 replyOnMainThread:(_Bool)arg3 completion:(CDUnknownBlockType)arg4 onError:(CDUnknownBlockType)arg5;
