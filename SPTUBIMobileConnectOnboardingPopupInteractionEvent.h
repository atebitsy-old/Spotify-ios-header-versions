...
@class NSArray, NSDictionary, NSString, SPTUBIMobileConnectOnboardingPopupInteractionEventLocation;

@interface SPTUBIMobileConnectOnboardingPopupInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileConnectOnboardingPopupInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileConnectOnboardingPopupInteractionEventLocation *location; // @synthesize location=_location;
