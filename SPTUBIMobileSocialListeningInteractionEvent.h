...
@class NSArray, NSDictionary, NSString, SPTUBIMobileSocialListeningInteractionEventLocation;

@interface SPTUBIMobileSocialListeningInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileSocialListeningInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileSocialListeningInteractionEventLocation *location; // @synthesize location=_location;
