...
@class NSArray, NSDictionary, NSString, SPTUBIMobileIosLockScreenInteractionEventLocation;

@interface SPTUBIMobileIosLockScreenInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileIosLockScreenInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileIosLockScreenInteractionEventLocation *location; // @synthesize location=_location;
