...
@class NSArray, NSDictionary, NSString, SPTUBIMobileBehindTheLyricsInteractionEventLocation;

@interface SPTUBIMobileBehindTheLyricsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileBehindTheLyricsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileBehindTheLyricsInteractionEventLocation *location; // @synthesize location=_location;
