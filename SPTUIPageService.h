...
@interface SPTUIPageService : NSObject <SPTService, SPTFeatureFlagSignalObserver>
{
    ...
    id <SPTFeatureFlagSignal> _principalEnabledSignal;
...
@property(retain, nonatomic) id <SPTFeatureFlagSignal> principalEnabledSignal; // @synthesize principalEnabledSignal=_principalEnabledSignal;
