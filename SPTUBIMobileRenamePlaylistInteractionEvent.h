...
@class NSArray, NSDictionary, NSString, SPTUBIMobileRenamePlaylistInteractionEventLocation;

@interface SPTUBIMobileRenamePlaylistInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileRenamePlaylistInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileRenamePlaylistInteractionEventLocation *location; // @synthesize location=_location;
