...
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIOfferCardRibbonStyle<GLUEStyle> *offerRibbonStyle;
...
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIBenefitsChartHeaderStyle<GLUEStyle> *benefitsChartHeaderStyle;
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIBenefitsChartRowStyle<GLUEStyle> *benefitsChartRowStyle;
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIBenefitsListRowStyle<GLUEStyle> *benefitsListRowStyle;
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIBenefitsHeaderStyle<GLUEStyle> *benefitsHeaderStyle;
@property(readonly, copy, nonatomic) SPTPremiumDestinationUIBenefitsCardStyle<GLUEStyle> *benefitsCardStyle;
