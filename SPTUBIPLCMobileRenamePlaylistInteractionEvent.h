...
@class NSArray, NSDictionary, NSString, SPTUBIPLCMobileRenamePlaylistInteractionEventLocation;

@interface SPTUBIPLCMobileRenamePlaylistInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIPLCMobileRenamePlaylistInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIPLCMobileRenamePlaylistInteractionEventLocation *location; // @synthesize location=_location;
