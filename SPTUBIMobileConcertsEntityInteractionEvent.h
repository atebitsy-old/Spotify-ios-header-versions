...
@class NSArray, NSDictionary, NSString, SPTUBIMobileConcertsEntityInteractionEventLocation;

@interface SPTUBIMobileConcertsEntityInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileConcertsEntityInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileConcertsEntityInteractionEventLocation *location; // @synthesize location=_location;
