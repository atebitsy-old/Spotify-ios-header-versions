...
#import "SPTUBIMobileYourLibraryLikedSongs_ItemListEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileYourLibraryLikedSongs_ItemListEventFactoryImplementation : NSObject <SPTUBIMobileYourLibraryLikedSongs_ItemListEventFactory>
{
    NSArray *_components;
}
