...
#import "SPTUBIMobileHome_ItemEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileHome_ItemEventFactoryImplementation : NSObject <SPTUBIMobileHome_ItemEventFactory>
{
    NSArray *_components;
}
