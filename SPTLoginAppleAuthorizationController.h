...
@class NSString, SPTAuthenticationHandler, SPTLoginAppleAuthorizationControllerLogger, SPTLoginAppleSignInTestManager, SPTSigninWithAppleHandler, SPTSignupAttemptTrackerImplementation;
...
@interface SPTLoginAppleAuthorizationController : NSObject <ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding>
{
    ...
    SPTLoginAppleSignInTestManager *_testManager;
...
@property(readonly, nonatomic) SPTLoginAppleSignInTestManager *testManager; // @synthesize testManager=_testManager;
