...
@class NSArray, NSDictionary, NSString, SPTUBIMobileLoginResetPasswordInteractionEventLocation;

@interface SPTUBIMobileLoginResetPasswordInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileLoginResetPasswordInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileLoginResetPasswordInteractionEventLocation *location; // @synthesize location=_location;
