...
- (void)resetFilters;
- (void)playWithPlayOrigin:(id)arg1 options:(id)arg2 loggingParams:(id)arg3 fallbackPlayer:(id)arg4;
- (void)playWithRecommendationsUsingPlayer:(id)arg1 loggingParams:(id)arg2 options:(id)arg3;
...
- (void)playTrackEntity:(id)arg1 playOrigin:(id)arg2 loggingParams:(id)arg3 fallbackPlayer:(id)arg4;
- (_Bool)isPlaybackPreventedByRestrictionsForSongEntity:(id)arg1 viewURI:(id)arg2;
- (void)shufflePlayWithPlayOrigin:(id)arg1 loggingParams:(id)arg2 fallbackPlayer:(id)arg3;
