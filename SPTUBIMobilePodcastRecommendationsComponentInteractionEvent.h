...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastRecommendationsComponentInteractionEventLocation;

@interface SPTUBIMobilePodcastRecommendationsComponentInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastRecommendationsComponentInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastRecommendationsComponentInteractionEventLocation *location; // @synthesize location=_location;
