...
@class NSArray, NSDictionary, NSString, SPTUBIMobileNowPlayingViewVideoShowInteractionEventLocation;

@interface SPTUBIMobileNowPlayingViewVideoShowInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileNowPlayingViewVideoShowInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileNowPlayingViewVideoShowInteractionEventLocation *location; // @synthesize location=_location;
