...
@class NSArray, NSDictionary, NSString, SPTUBIMobileQueueInteractionEventLocation;

@interface SPTUBIMobileQueueInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileQueueInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileQueueInteractionEventLocation *location; // @synthesize location=_location;
