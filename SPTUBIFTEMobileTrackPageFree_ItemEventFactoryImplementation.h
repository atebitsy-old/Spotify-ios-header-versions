...
#import "SPTUBIFTEMobileTrackPageFree_ItemEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIFTEMobileTrackPageFree_ItemEventFactoryImplementation : NSObject <SPTUBIFTEMobileTrackPageFree_ItemEventFactory>
{
    NSArray *_components;
}
