...
@class NSString;
@protocol SPTCollectionLogger, SPTCollectionPlatform, SPTOfflineManager, SPTPodcastDataLoader, SPTPodcastLogger, SPTPodcastOffliningManager, SPTPodcastTestManager, SPTShow, SPTShowEntityService;
