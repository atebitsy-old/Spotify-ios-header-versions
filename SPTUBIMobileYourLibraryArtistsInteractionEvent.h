...
@class NSArray, NSDictionary, NSString, SPTUBIMobileYourLibraryArtistsInteractionEventLocation;

@interface SPTUBIMobileYourLibraryArtistsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileYourLibraryArtistsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileYourLibraryArtistsInteractionEventLocation *location; // @synthesize location=_location;
