...
@class NSArray, NSDictionary, NSString, SPTUBIMobileHomeInteractionEventLocation;

@interface SPTUBIMobileHomeInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileHomeInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileHomeInteractionEventLocation *location; // @synthesize location=_location;
