...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastEmptyInteractionEventLocation;

@interface SPTUBIMobilePodcastEmptyInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastEmptyInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastEmptyInteractionEventLocation *location; // @synthesize location=_location;
