...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePremiumDestinationInteractionEventLocation;

@interface SPTUBIMobilePremiumDestinationInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePremiumDestinationInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePremiumDestinationInteractionEventLocation *location; // @synthesize location=_location;
