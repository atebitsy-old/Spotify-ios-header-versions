...
@class NSString, SPTPremiumDestinationUIFlexboxChildComponentViewController;
@protocol HUBComponentViewChildDelegate;

@interface SPTPremiumDestinationUIFlexboxContainerComponentView : HUBComponentView <SPTPremiumDestinationUIFlexboxChildComponentViewControllerDataSource, HUBComponentViewWithChildren>
{
