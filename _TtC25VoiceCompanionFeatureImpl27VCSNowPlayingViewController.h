...
@interface _TtC25VoiceCompanionFeatureImpl27VCSNowPlayingViewController : SPViewController
{
    // Error parsing type: , name: viewModel
    // Error parsing type: , name: playlistRowView
    // Error parsing type: , name: playingRowView
