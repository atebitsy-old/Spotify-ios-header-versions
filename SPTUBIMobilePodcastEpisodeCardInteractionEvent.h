...
@class NSArray, NSDictionary, NSString, SPTUBIMobilePodcastEpisodeCardInteractionEventLocation;

@interface SPTUBIMobilePodcastEpisodeCardInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobilePodcastEpisodeCardInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobilePodcastEpisodeCardInteractionEventLocation *location; // @synthesize location=_location;
