...
#import "SPTUBIMobileSearch_Content_OnlineResults_TopResults_ResultItemEventFactory-Protocol.h"

@class NSArray, NSString;

@interface SPTUBIMobileSearch_Content_OnlineResults_TopResults_ResultItemEventFactoryImplementation : NSObject <SPTUBIMobileSearch_Content_OnlineResults_TopResults_ResultItemEventFactory>
{
    NSArray *_components;
}
