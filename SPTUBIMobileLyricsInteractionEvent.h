...
@class NSArray, NSDictionary, NSString, SPTUBIMobileLyricsInteractionEventLocation;

@interface SPTUBIMobileLyricsInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileLyricsInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileLyricsInteractionEventLocation *location; // @synthesize location=_location;
