...
@class NSArray, NSDictionary, NSString, SPTUBIMobileHiddenContentInteractionEventLocation;

@interface SPTUBIMobileHiddenContentInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileHiddenContentInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileHiddenContentInteractionEventLocation *location; // @synthesize location=_location;
