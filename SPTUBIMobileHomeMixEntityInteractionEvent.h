...
@class NSArray, NSDictionary, NSString, SPTUBIMobileHomeMixEntityInteractionEventLocation;

@interface SPTUBIMobileHomeMixEntityInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileHomeMixEntityInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileHomeMixEntityInteractionEventLocation *location; // @synthesize location=_location;
