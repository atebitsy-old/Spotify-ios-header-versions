...
@class NSArray, NSDictionary, NSString, SPTUBIMobileNotificationsPreferencesDefaultIosInteractionEventLocation;

@interface SPTUBIMobileNotificationsPreferencesDefaultIosInteractionEvent : NSObject <SPTUBIInteractionEvent>
{
    SPTUBIMobileNotificationsPreferencesDefaultIosInteractionEventLocation *_location;
    NSString *_action;
...
@property(retain, nonatomic) SPTUBIMobileNotificationsPreferencesDefaultIosInteractionEventLocation *location; // @synthesize location=_location;
